...
c Thick disk component:
     ...
     .                na,ha,wa,Aa,Fa
        ...
        real pihalf, rad
        parameter(pihalf=3.14159265358979323846264/2.0)
        parameter(rad=57.2957795130823)
...
c-----------------------------------------------------------------------
     ...
     .                whicharm, wlism, wLDR, wLHB, wLSB, wLOOPI,
     .                hitclump, hitvoid, wvoid)
        negal=ne1+ne2+nea+negc+nelism+necN+nevN
        return
        end
         
        REAL FUNCTION ne_thick(x,y,z)
        implicit none
        real x,y,z
        real ne1,ne2,nea,negc,nelism,necN,nevN
        real F1, F2, Fa, Fgc, Flism, FcN, FvN 
     ...
     .                hitclump, hitvoid, wvoid)
        ...
        REAL FUNCTION ne_localism(x,y,z)
        implicit none
        real x,y,z
        real ne1,ne2,nea,negc,nelism,necN,nevN
        real F1, F2, Fa, Fgc, Flism, FcN, FvN 
